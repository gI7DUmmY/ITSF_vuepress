...
### 9.2
Lors de toute compétition de double, les deux équipes peuvent changer de position durant un temps mort ([voir article 14.1](/rules/positions.md#_14-1)).
...
### 9.7
Si une équipe n’est pas prête à reprendre le jeu lorsque les 30 secondes sont écoulées, elle se verra attribuée une pénalité pour avoir retardé la partie ([voir article 25](/rules/retard.md)).
